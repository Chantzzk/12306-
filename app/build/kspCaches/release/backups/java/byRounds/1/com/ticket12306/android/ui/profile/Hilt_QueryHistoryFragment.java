...
public abstract class Hilt_QueryHistoryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_QueryHistoryFragment() {
    super();
  }

  Hilt_QueryHistoryFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((QueryHistoryFragment_GeneratedInjector) this.generatedComponent()).injectQueryHistoryFragment(UnsafeCasts.<QueryHistoryFragment>unsafeCast(this));
    }
  }
