...
public class SeatSelectFragmentDirections private constructor() {
  private data class ActionSeatSelectFragmentToBookingConfigFragment(
    public val ticketInfo: TicketInfo?,
    public val bookingTask: BookingTask?,
  ) : NavDirections {
    public override val actionId: Int = R.id.action_seatSelectFragment_to_bookingConfigFragment
  ...
  public companion object {
    public fun actionSeatSelectFragmentToBookingConfigFragment(ticketInfo: TicketInfo?,
        bookingTask: BookingTask?): NavDirections =
        ActionSeatSelectFragmentToBookingConfigFragment(ticketInfo, bookingTask)
  }
}
