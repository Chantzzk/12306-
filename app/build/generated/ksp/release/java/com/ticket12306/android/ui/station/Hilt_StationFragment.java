...
public abstract class Hilt_StationFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_StationFragment() {
    super();
  }

  Hilt_StationFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((StationFragment_GeneratedInjector) this.generatedComponent()).injectStationFragment(UnsafeCasts.<StationFragment>unsafeCast(this));
    }
  }
