...
public abstract class Hilt_BookingConfigFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BookingConfigFragment() {
    super();
  }

  Hilt_BookingConfigFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BookingConfigFragment_GeneratedInjector) this.generatedComponent()).injectBookingConfigFragment(UnsafeCasts.<BookingConfigFragment>unsafeCast(this));
    }
  }
