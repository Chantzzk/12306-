...
public abstract class Hilt_PassengerManageFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PassengerManageFragment() {
    super();
  }

  Hilt_PassengerManageFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PassengerManageFragment_GeneratedInjector) this.generatedComponent()).injectPassengerManageFragment(UnsafeCasts.<PassengerManageFragment>unsafeCast(this));
    }
  }
