...
public abstract class Hilt_StationSelectFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_StationSelectFragment() {
    super();
  }

  Hilt_StationSelectFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((StationSelectFragment_GeneratedInjector) this.generatedComponent()).injectStationSelectFragment(UnsafeCasts.<StationSelectFragment>unsafeCast(this));
    }
  }
