...
public abstract class Hilt_SeatSelectFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SeatSelectFragment() {
    super();
  }

  Hilt_SeatSelectFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SeatSelectFragment_GeneratedInjector) this.generatedComponent()).injectSeatSelectFragment(UnsafeCasts.<SeatSelectFragment>unsafeCast(this));
    }
  }
