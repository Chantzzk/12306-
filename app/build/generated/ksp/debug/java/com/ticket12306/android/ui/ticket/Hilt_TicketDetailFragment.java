...
public abstract class Hilt_TicketDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TicketDetailFragment() {
    super();
  }

  Hilt_TicketDetailFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TicketDetailFragment_GeneratedInjector) this.generatedComponent()).injectTicketDetailFragment(UnsafeCasts.<TicketDetailFragment>unsafeCast(this));
    }
  }
